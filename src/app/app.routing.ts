...
export const appRoutes: Route[] = [
    ...
    { path: 'signed-in-redirect', pathMatch: 'full', redirectTo: 'tours' },
    ...
    // Auth routes for guests
    {
        ...
        children: [
            ...
            { path: 'service-down', loadChildren: () => import('app/modules/auth/in-maintenance/in-maintenance.module').then(m => m.InMaintenanceModule) }
        ]
    },
