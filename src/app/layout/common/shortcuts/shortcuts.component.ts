...
{
    @ViewChild('shortcutsOrigin', { static: false }) private _shortcutsOrigin: MatButton;
    @ViewChild('shortcutsPanel', { static: false }) private _shortcutsPanel: TemplateRef<any>;
