...
export class FuseMediaWatcherService
{
    ...
    )
    {
        ...
        //     switchMap((config:any) => this._breakpointObserver.observe(Object.values(config.breakpoints)).pipe(
        //         map((state:any) => {
        ...
        //                 let matchingAlias:any = config.breakpoints.find(([alias, q]) => q === query)[0];
