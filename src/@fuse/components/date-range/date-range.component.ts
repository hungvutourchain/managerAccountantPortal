...
export class FuseDateRangeComponent implements ControlValueAccessor, OnInit, OnDestroy
{
    ...
    @ViewChild('matMonthView1', { static: false }) private _matMonthView1: MatMonthView<any>;
    @ViewChild('matMonthView2', { static: false }) private _matMonthView2: MatMonthView<any>;
    @ViewChild('pickerPanelOrigin', {read: ElementRef}) private _pickerPanelOrigin: ElementRef;
    @ViewChild('pickerPanel', { static: false }) private _pickerPanel: TemplateRef<any>;
